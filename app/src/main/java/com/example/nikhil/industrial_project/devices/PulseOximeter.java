...
import com.example.nikhil.industrial_project.listeners.PulseOximeterListener.PulseOximeterStatus;
...
public class PulseOximeter {
            ...
            while(mmCancel==false) {
	            ...
	            if(mmCancel==false && mmSocket.isConnected()) {
		    		...
		    		if(mmCancel==false && tmpInStream!=null) {
		    			...
		    			mListener.onAliveStatus(PulseOximeterStatus.PO_STATUS_CONNECTED);
        		...
        		if(!mmCancel) {
        			mListener.onAliveStatus(PulseOximeterStatus.PO_STATUS_RECONNECTING);
        			try {
    ...
    public synchronized void stopConnection() {
    	...
    	mListener.onAliveStatus(PulseOximeterStatus.PO_STATUS_NONE);
    }
    public synchronized void startConnection()
    {
        ...
        mListener.onAliveStatus(PulseOximeterStatus.PO_STATUS_CONNECTING);
    }
